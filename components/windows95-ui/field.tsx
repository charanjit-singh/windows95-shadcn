...
function Checkbox({
  ...
  return (
    <CheckboxPrimitive.Root
      data-slot="checkbox"
      className={cn(
        "peer win95-border-input bg-white h-4 w-4 shrink-0 shadow-sm focus-visible:outline-none focus-visible:ring-0 disabled:cursor-not-allowed disabled:bg-gray-200 disabled:text-gray-500 data-[state=checked]:bg-white data-[state=checked]:text-black",
        className
      )}
      {...props}
    >
...
function RadioGroupItem({
  ...
  return (
    <RadioGroupPrimitive.Item
      ...
      className={cn(
        "aspect-square h-4 w-4 rounded-full win95-border-input bg-white text-black shadow-sm focus:outline-none focus-visible:ring-0 disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
      {...props}
    >
